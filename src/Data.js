...
export default {
	...
	intro:
		"With most UI/UX and coding project I rely heavily on user interviews to begin. Knowing the users story, creating their empathy maps, documenting their pain points and overall needs helps me start with an idea of who the user is. From there I can create Personas that the project may refer to while moving forward. Contextual inquiry and journey mapping help me develop diagrams that will depict stages the user will interact with while navigating my project. Having this information helps guid my preliminary wireframes, or Lo-Fi Mockups, which are essential for user testing. Through user testing I can evaluate a project or product feature in a easily updated prototype to evaluate real user interaction. Any number of these steps may be revisited to inform th stages leading up to coding a project. Finally High fidelity mockups help me to visualize the finally stages of the project before coding begins.",
	projects: [
		{
			id: 1,
