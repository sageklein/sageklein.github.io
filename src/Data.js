...
export default {
	...
	abouttext:
		"As a Front End Web Developer I am passionate about combining my love of coding with my love of continued learning. With my UI/UX Design training and strong communication skills I produce beautiful and well thought out design work. With a positive attitude and strong growth mindset, I am self motivated and work well in groups. Empathy, persistence, curiosity and an obsession with details are my motivating factors when designing.",
	abouttext2:
		"When I'm not working on design projects or coding, I love to watch boxing! My favorite boxer is Gennadiy Gennadyevich Golovkin. I have a bag at home and love to shadow box! I also enjoy needle point and cross stitch. I am a very creative person with lots of diverse hobbies. I also love animals, I have 2 cats and a 14 year old Sulcata Tortoise!",
	aboutImage: me,
	ShowAboutImage: true,

	intro:
		"With UI/UX Design and Front End Web-Development project I rely heavily on user interviews to begin. Knowing the users story, creating or going over their empathy maps, documenting their pain points and overall needs helps me start with an idea of who the user is and how I can help them.",
	...
	intro3:
		"Any number of these steps may be revisited to inform the stages leading up to coding a project. High fidelity mockups help me to visualize the finally stages of the project before coding begins.",
	projects: [
		{
			id: 1,
